...
const createThread = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json(yield threadService.createThread(userId, threadId, content));
    }
    catch (error) {
        console.log(error);
...
function createThreadWImage(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            res.status(200).json(yield threadService.createThreadWImage(userId, threadId, content, files));
        }
        catch (error) {
            console.log(error);
            (0, errorHandler_1.errorHandler)(error, res);
...
const getReplies = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json(yield threadService.getReplies(threadId));
    }
    catch (error) {
        console.log(error);
        (0, errorHandler_1.errorHandler)(error, res);
